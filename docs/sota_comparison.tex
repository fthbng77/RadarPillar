...
\rowcolor{rowalt}
10 & \ours{Bizim (default, en iyi)}         & --         & \ours{39{,}2}   & \ours{42{,}6}   & \ours{68{,}4}   & \ours{49{,}9}  & 5 \\
\rowcolor{rowalt}
11 & \ours{Bizim (vel.\ decomp, en iyi)}    & --         & \ours{38{,}7}   & \ours{41{,}8}   & \ours{69{,}8}   & \ours{49{,}9}  & 5 \\
...
\midrule
Bizim -- default (en iyi epoch)     & 39{,}2          & \textbf{42{,}6} \gain{4{,}0}   & 68{,}4          & 49{,}9 \\
Bizim -- vel.\ decomp (en iyi epoch) & 38{,}7         & 41{,}8 \gain{3{,}2}            & 69{,}8          & 49{,}9 \\
\midrule
\multicolumn{5}{@{}l}{\textit{Makaleye göre sınıf bazlı fark:}} \\
\quad default                       & \loss{$-$1{,}9} & \gain{4{,}0}                & \loss{$-$4{,}2} & \loss{$-$0{,}8} \\
\quad vel.\ decomp                  & \loss{$-$2{,}4} & \gain{3{,}2}                & \loss{$-$2{,}8} & \loss{$-$0{,}8} \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}[nosep]
    \item Yaya algılama, makaleyi +3{,}2 ile +4{,}0 AP arasında \textbf{geçmektedir}.
    \item Bisikletli algılama en büyük açığı oluşturmaktadır ($-$2{,}8 ile $-$4{,}2 AP).
    \item Genel mAP farkı yalnızca $-$0{,}8 olup makale performansına yakın konumdayız.
\end{itemize}
...
\midrule
default (ayrıştırmasız)  & \textbf{39{,}21} & \textbf{42{,}58} & 68{,}38          & \textbf{49{,}93} & 54 \\
velocity\_decomp         & 38{,}66          & 41{,}79          & \textbf{69{,}76} & 49{,}92          & 56 \\
\midrule
$\Delta$                 & \loss{$-$0{,}55} & \loss{$-$0{,}79} & \gain{1{,}38}    & $-$0{,}01        & -- \\
\bottomrule
\end{tabular}
\end{table}

\noindent
Hız ayrıştırma, Bisikletli AP'yi +1{,}38 artırmakta ancak Araba ($-$0{,}55) ve Yaya ($-$0{,}79) değerlerini hafifçe düşürmektedir. Genel mAP neredeyse aynıdır. Makale, ayrıştırmadan +3{,}8 mAP kazanç raporlamaktadır; bizdeki daha küçük kazanç, ayrıştırılmış özelliklerle kısmen örtüşen ek ham hız özelliklerinin (v$_r$, v$_{r,\text{comp}}$, time) varlığından kaynaklanıyor olabilir.

% ============================================================
\section{Sonuç}

RadarPillar implementasyonumuz, VoD veri setinde rekabetçi sonuçlar (mAP ${\sim}$49{,}9) elde ederek yalnızca radar yöntemleri arasında 8--9. sırada yer almakta ve orijinal makalenin raporladığı performansın 0{,}8 mAP dahilinde kalmaktadır. Ana açık Bisikletli ($-$2{,}8 ile $-$4{,}2 AP) ve Araba ($-$1{,}9 AP) sınıflarındayken, Yaya algılama makaleyi +3{,}2 ile +4{,}0 AP \textit{geçmektedir}.

Güncel en iyi sonuca (MAFF-Net, 54{,}6 mAP) olan fark yaklaşık 4{,}7 mAP'tır. Literatür analizi, en etkili iyileştirmelerin şunlar olacağını ortaya koymaktadır:
